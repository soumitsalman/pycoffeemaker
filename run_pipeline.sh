...
DIGESTOR_VLLM_USE_V2_MODEL_RUNNER="${DIGESTOR_VLLM_USE_V2_MODEL_RUNNER:-1}"
CONSOLIDATOR_VLLM_USE_V2_MODEL_RUNNER="${CONSOLIDATOR_VLLM_USE_V2_MODEL_RUNNER:-1}"
...
run_digestor() {
    VLLM_USE_V2_MODEL_RUNNER="$DIGESTOR_VLLM_USE_V2_MODEL_RUNNER" \
        $PYTHON "$RUN" --mode DIGESTOR --batch_size "$DIGESTOR_BATCH_SIZE"
}

run_consolidator() {
    VLLM_USE_V2_MODEL_RUNNER="$CONSOLIDATOR_VLLM_USE_V2_MODEL_RUNNER" \
