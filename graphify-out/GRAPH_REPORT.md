...
## Corpus Check
- 68 files · ~64,899 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2586 nodes · 4234 edges · 185 communities (126 shown, 59 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 281 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `94de33d9`
...
Cohesion: 0.06
Nodes (21): db_instance(), migrate(), _beans_to_df(), create_db(), DuckDB, _publishers_to_df(), # TODO: merge this with ducklakesack since the logic is mostly the same, just di, _select() (+13 more)
...
Cohesion: 0.1
Nodes (21): batch_search(), _copy_insert_state_rows(), _copy_insert_state_rows_async(), _create_multi_state_query_expr(), create_query_expr(), _create_rows(), _create_single_state_query_expr(), _create_state_tables_sql() (+13 more)

### Community 16 - "Community 16"
Cohesion: 0.09
Nodes (28): _extract_jsonld_content(), _is_parseable_html(), _is_pdf_content(), _is_pdf_url(), _parse_jsonld_body(), Scrape a PDF and convert it to markdown content., Scrape a PDF and convert it to markdown content., Scrape a single URL for both bean and publisher data. (+20 more)
...
Cohesion: 0.08
Nodes (25): AINewsDigest, _apply_model_json_constraints(), cleanup_digest_fields(), CyberNewsDigest, Digest, FinancialDocumentSummary, LogisticsDigest, MacroEconomyDigest (+17 more)

### Community 20 - "Community 20"
Cohesion: 0.09
Nodes (12): create_embedder(), LlamaCppEmbeddings, ORTEmbeddings, OVEmbeddings, # NOTE: moving the import inside the function so that there is no need to instal, # NOTE: moving the import inside the function so that there is no need to instal, # NOTE: moving the import inside the function so that there is no need to instal, RemoteEmbeddings (+4 more)
...
Cohesion: 0.08
Nodes (26): Scrape a single page for both bean and publisher data., Scrape a single URL for both bean and publisher data., Scrape multiple URLs in parallel for bean and publisher data., Scrape multiple URLs in parallel for bean and publisher data., Scrape a single URL for both bean and publisher data., Scrape a single URL for both bean and publisher data., Scrape a single page for both bean and publisher data., Scrape multiple URLs in parallel for bean and publisher data. (+18 more)
...
Cohesion: 0.1
Nodes (15): _clean_null_bytes(), create_db(), Cupboard, Store a list of sips in the database., Store a list of sips in the database., Store a list of sips in the database., Store a list of sips in the database., Store a list of sips in the database. (+7 more)
...
Cohesion: 0.14
Nodes (11): Collector, parse_sources(), Store storable collection results and persist the rest for scraping., Store storable collection results and persist the rest for scraping., Store storable collection results and persist the rest for scraping., Store storable collection results and persist the rest for scraping., Store storable collection results and persist the rest for scraping., Store storable collection results and persist the rest for scraping. (+3 more)
...
Cohesion: 0.16
Nodes (8): Sip, Source, load_espresso_to_cupboard(), CupboardPorter, prep_events(), prep_signals(), prep_sources(), merge_tags()
...
Cohesion: 0.12
Nodes (13): AsyncWebScraper, _convert_pdf_to_markdown(), Process worker: convert a PDF file to markdown., Process worker: convert a PDF file to markdown., Process worker: convert a PDF file to markdown., Process worker: convert a PDF file to markdown., Sync: single lxml parse for metadata only., Process worker: convert a PDF file to markdown. (+5 more)
...
Cohesion: 0.12
Nodes (15): # TODO: add a check to remove "advertisement", Collects the body of the url as a markdown, Collects the body of the url as a markdown, Collects the body of the url as a markdown, Collects the body of the url as a markdown, Collects the body of the url as a markdown, Collects the body of the url as a markdown, Collects the body of the url as a markdown (+7 more)
...
Cohesion: 0.12
Nodes (12): Test warehouse maintenance tasks, Test warehouse maintenance tasks, Test warehouse maintenance tasks, Test warehouse maintenance tasks, Test querying unprocessed beans, Test querying unprocessed beans, Test querying processed beans, Test querying processed beans (+4 more)
...
- **What is the exact relationship between `Publisher` and `PUBLISHED graph edge`?**
  _Edge tagged AMBIGUOUS (relation: semantically_similar_to) - confidence is low._
- **Why does `now()` connect `Community 18` to `Community 1`, `Community 65`, `Community 33`, `Community 5`, `Community 38`, `Community 41`, `Community 30`, `Community 24`, `Community 27`, `Community 94`?**
